        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-flex items-center gap-2 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white text-purple-600 font-bold shadow-lg">
                P
              </div>
              <span className="text-2xl font-bold">ProgresslyHub</span>
            </Link>
            <p className="text-purple-100 text-sm mb-6 max-w-xs">
              Effortless task management for teams and individuals. Stay organized, focused, and productive.
            </p>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-all hover:scale-110"
                aria-label="Facebook"
              >
              ...
              {!user ? (
                <>
                  <li>
                    <Link
                      to="/auth/login"
                      className="text-purple-100 hover:text-white transition-colors inline-flex items-center group"
                    >
                ...
                <>
                  ...
                  <li>
                    <Link
                      ...
                      className="text-purple-100 hover:text-white transition-colors inline-flex items-center group"
                    >
                      <span className="group-hover:translate-x-1 transition-transform">Tasks</span>
                    </Link>
                  </li>
                  <li>
                    <Link
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-0 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-purple-100 text-sm">
              © {year} ProgresslyHub. All rights reserved. Made with ❤️ for productive teams.
            </p>
            <div className="flex gap-6 text-sm">
              <Link to="/sitemap" className="text-purple-100 hover:text-white transition-colors">
                Sitemap
              </Link>
              <Link to="/status" className="text-purple-100 hover:text-white transition-colors">
                Status
              </Link>
              <Link to="/support" className="text-purple-100 hover:text-white transition-colors">
                Support
              </Link>
            </div>
          </div>
